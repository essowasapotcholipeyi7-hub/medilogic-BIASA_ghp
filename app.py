...
if IS_PRODUCTION:
    ...
    # perso au lieu de onrender.com.
    BASE_URL = os.environ.get('APP_BASE_URL') or os.environ.get('RENDER_EXTERNAL_URL', 'https://medilogic-biasa-ghp.onrender.com')
else:
...
def admin_reset_password(structure_id):
    ...
    par email (reset_password() ci-dessus) : hash_password(), jamais
...
# celles des blueprints (enregistrés plus haut — un blueprint publie ses
# endpoints dans app.view_functions dès register_blueprint()).
